"""
Suite configuration for mach4_ema_band_ep1
==========================================
"""
...
TEST_CONFIG = {
    "insample_excellence": {
        ...
        "start": "2024-03-01",
        "end": "2026-03-01",
        # Optional: override Parquet cache path only (must match filename in data/).
        # Filenames: ``{symbol}_{interval}_{provider}_{cache_start}_{cache_end}[_{session}].parquet``.
