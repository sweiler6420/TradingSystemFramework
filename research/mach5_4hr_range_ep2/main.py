"""
Mach5 4Hr Range Ep2 � research entry (optional)
===============================================

Preferred: from repo root run ``python research/run.py mach5_4hr_range_ep2``
(or ``5`` / ``mach5`` if unambiguous). That uses :mod:`research.research_runner` and
